  ...
  return (
    <div className="bg-gray-900 text-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center p-4">
        ...
        <div className="flex items-center mb-2 md:mb-0 dark">
          <svg
          ...
          <span className="px-2">From Sequence</span>
        </div>


        <div className="flex items-center mb-2 md:mb-0 text-xl font-bold">
            <div className="text-secondry-400 mx-2">{from}</div>
            <div className="text-white mx-2">&#8594;</div>
            <div className="text-secondry-400 mx-2">{to}</div>
        </div>

        <div className="flex items-center dark">
          <span className="px-2">To Sequence</span>
          <svg
            class="w-6 h-6 text-gray-800 dark:text-white"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
